...
# 4. Desplegar contrato y registrar usuarios
Write-Host "[4/5] Desplegando contrato y registrando usuarios..." -ForegroundColor Yellow
cd backend
forge script script/Deploy.s.sol --rpc-url http://localhost:8545 --broadcast --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 | Out-Null
$contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"
Write-Host "[OK] Sistema desplegado" -ForegroundColor Green
Write-Host "   - Contrato: $contractAddress" -ForegroundColor Cyan
Write-Host "   - Usuarios de prueba registrados (estado: PENDING)" -ForegroundColor Yellow
cd ..
Write-Host ""
...
Write-Host "  - Admin: 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266" -ForegroundColor White
Write-Host "  - Frontend: http://localhost:3000" -ForegroundColor White
Write-Host ""
Write-Host "CUENTAS DE PRUEBA REGISTRADAS (estado: PENDING):" -ForegroundColor Yellow
Write-Host "  - PRODUCER : 0x70997970C51812dc3A010C7d01b50e0d17dc79C8" -ForegroundColor Cyan
Write-Host "  - FACTORY  : 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC" -ForegroundColor Cyan
Write-Host "  - RETAILER : 0x90F79bf6EB2c4f870365E785982E1f101E93b906" -ForegroundColor Cyan
Write-Host "  - CONSUMER : 0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  4. Conecta como ADMIN (Account 0) y aprueba los usuarios" -ForegroundColor White
Write-Host "  5. Luego conecta con cualquier cuenta de prueba (1-4)" -ForegroundColor White
Write-Host ""
Write-Host "NOTA: Los usuarios están en estado PENDING y necesitan aprobación del admin" -ForegroundColor Red
Write-Host ""
